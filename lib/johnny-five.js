 ...
 */
module.exports.IR.Distance = util.deprecate(function(opts) {
  return new module.exports.Distance(opts);
}, "IR.Distance is deprecated. Use Proximity instead");

/**
 * @deprecated Will be deleted in version 1.0.0. Use Motion instead.
 */
module.exports.IR.Motion = util.deprecate(function(opt) {
  return new module.exports.Pir(
    typeof opt === "number" ? opt : (
      opt.pin === undefined ? 7 : opt.pin
    )
  );
}, "IR.Motion is deprecated. Use Motion instead");

/**
 * @deprecated Will be deleted in version 1.0.0. Use Proximity instead.
 */
module.exports.IR.Proximity = util.deprecate(function(opts) {
...
}, "IR.Proximity is deprecated. Use Proximity instead");
